...
function updateCharacter() {
  ...
  // Mettre à jour infos textuelles
  ...
  // Mettre à jour barre de puissance
  ...
  // Ajouter hover sur transformations sans changer le cadre
  document.querySelectorAll('.transformation').forEach(el => {
    ...
    el.addEventListener('mouseover', () => {
      hoverTimeout = setTimeout(() => {
        ...
        setTimeout(() => {
          charImg.src = el.dataset.img; // Change l'image uniquement
          charImg.style.opacity = 1;
        }, 200);
      }, 200);
    });
    ...
    el.addEventListener('mouseout', () => {
      ...
      charImg.style.opacity = 0;
      setTimeout(() => {
        charImg.src = char.img; // Reviens à l'image de base
        charImg.style.opacity = 1;
      }, 200);
    });
  });
